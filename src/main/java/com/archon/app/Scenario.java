...
public final class Scenario {
    ...
    public static World testRoom(Dice dice) {
        ...
        t.setSlot(EquipmentSlot.HAND_RIGHT, Item.weapon("rusted_cleaver", "rusted cleaver", 6, 10, Tag.METAL));
        t.setSlot(EquipmentSlot.HAND_LEFT,  new Item("torch", "torch", Set.of(Tag.WOOD, Tag.LIT), null, 20, 1));
