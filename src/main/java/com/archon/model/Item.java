...
public final class Item {
    ...
    public static Item weapon(String id, String name, int damage, int durability, Tag... tags) {
        ...
        if (tags != null) Collections.addAll(itemTags, tags);
    ...
    public Tag substance() { return substance; }
    public int durability() { return durability; }
    public int damage() { return damage; }
    public boolean has(Tag tag) { return tags.contains(tag); }
    public Tag consumeSubstance() { Tag value = substance; substance = null; return value; }
    public void wear(int amount) { if (amount < 0) throw new IllegalArgumentException("wear cannot be negative"); durability -= amount; }
